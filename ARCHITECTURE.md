...
- **Verifying changes:** backend has `pytest` (**229 tests** across `tests/`);
  frontend has Vitest + React Testing Library (**502 tests in 36 files**) — run
