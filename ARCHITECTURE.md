...
- **Verifying changes:** backend has `pytest` (**360 tests** across `tests/`);
  frontend has Vitest + React Testing Library (**572 tests in 45 files**) — run
