...
- **Verifying changes:** backend has `pytest` (**100 tests** across `tests/`);
  frontend has Vitest + React Testing Library (**202 tests in 22 files**) — run
