...
- **Verifying changes:** backend has `pytest` (**293 tests** across `tests/`);
  frontend has Vitest + React Testing Library (**489 tests in 40 files**) — run
