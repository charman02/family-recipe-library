...
- **Verifying changes:** backend has `pytest` (**345 tests** across `tests/`);
  frontend has Vitest + React Testing Library (**557 tests in 45 files**) — run
