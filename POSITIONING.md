...
As measured on this branch (see `README.md` for the method): **28 routes**, **9 models**,
**222 backend tests**, **483 frontend tests in 34 files**. Endpoint and test counts have
