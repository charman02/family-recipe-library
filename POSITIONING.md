...
As measured on this branch (see `README.md` for the method): **29 routes**, **9 models**,
**229 backend tests**, **502 frontend tests in 36 files**. Endpoint and test counts have
