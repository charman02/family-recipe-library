...
As measured on this branch (see `README.md` for the method): **42 routes**, **11 models**,
**293 backend tests**, **489 frontend tests in 40 files**. Endpoint and test counts have
