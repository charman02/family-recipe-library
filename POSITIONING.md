...
As measured on this branch (see `README.md` for the method): **27 routes**, **9 models**,
**202 backend tests**, **479 frontend tests in 34 files**. Endpoint and test counts have
